...
public class CdrRestController {
    ...
    /**
     * Генерация записей данных вызовов за прошлый год, начиная с текущей даты (текущая дата - 1 год).
     * <p>
    ...
    @Operation(
            ...
            description = "Генерирует записи данных вызовов (CDR) за прошлый год, начиная с текущей даты (текущая дата - 1 год)"
    )
    @ApiResponses(value = {
